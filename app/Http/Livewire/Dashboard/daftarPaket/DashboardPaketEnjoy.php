...
class DashboardPaketEnjoy extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.dashboard.daftar-paket.dashboard-paket-Enjoy', [
            'hairEnjoy' => Antrian::where('paket', 'enjoy')->where('is_call', 0)->paginate(10)
        ]);
    }
}
