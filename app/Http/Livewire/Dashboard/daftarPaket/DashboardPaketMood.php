...
class DashboardPaketMood extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.dashboard.daftar-paket.dashboard-paket-mood',[
            'goodMood' => Antrian::where('paket', 'mood')->where('is_call', 0)->paginate(10)
        ]);
    }
}
