        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bx bx-bar-chart-square"></i><span>Iklan</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/dashboard/iklan/index">
                            <i class="bi bi-circle"></i><span>Permintaan Iklan</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('indexApproved') }}">
                            <i class="bi bi-circle"></i><span>Iklan Approved</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/dashboard/antrian/hairCut">
                            <i class="bi bi-circle"></i><span>List Antrian</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Components Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/dashboard/user/index">
